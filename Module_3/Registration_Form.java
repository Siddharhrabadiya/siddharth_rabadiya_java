...
public class Registration_Form extends WindowAdapter implements ActionListener
{
	JFrame frame;
	...
	public Registration_Form()
	{
      ...
      frame.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        ...
        new String [] {
            "S.NO", "ID", "NAME", "GENDER", "ADDRESS", "CONTACT"
        }));
								...
								btnupdate.addActionListener(new ActionListener() {
									...
									public void actionPerformed(ActionEvent e) {
										...
										try 
										{
											Class.forName("com.mysql.jdbc.Driver");
											Connection con= DriverManager.getConnection(url,"root","");
											String sql="Update info set name = '"+name+"' , address ='"+address+"',contact='"+contact+"',gender='"+gender+"' where id='"+id3+"'";
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{
			Class.forName("com.mysql.jdbc.Driver");
			Connection con =DriverManager.getConnection("jdbc:mysql://localhost:3306/Registration_form","root","");
			String sql ="insert into info values ('"+Sno+"','"+id+"','"+name+"','"+address+"','"+contact+"','"+gender+"')";
			Statement st =con.createStatement();
			int a = st.executeUpdate(sql);
			if(a>0)
			{
				System.out.println("Insertsed");
			}
			else
			{
